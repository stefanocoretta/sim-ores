...
![Ian Malcom, chaotician](https://upload.wikimedia.org/wikipedia/en/6/60/Ian_Malcolm_%28Jeff_Goldblum%29.jpg){fig-align="center" width="300"}
...
## {background-image="../img/dusan-veverkolog-mX2mdxhc0UM-unsplash.jpg" .center}
...
::: {.callout-note appearance="simple"}
::: incremental
-   **Uninterpretability** of conceptual models [@meehl1990]{.small-ref}

-   "We are not even wrong" [@scheel2022]{.small-ref}

-   Lack of meaningful **connection** between verbal generalisations and evidence. [@yarkoni2022]{.small-ref}

-   Replicable results do not imply correct conditional inference and non-replicable results do not imply incorrect conditional inference. [@devezer2019]{.small-ref}
:::
:::
